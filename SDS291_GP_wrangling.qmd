...
Charavee- I think we should do just total death right, because the cause of disease is not directly linked to our study? 

Sorry, what values are in the `FactValueNumeric` variable right now? The probability of death for each cause, sex etc.? 
