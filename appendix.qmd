...
### Contrast 3: consec: Fixing number of doctors per 100,000

```{r, message = FALSE, echo = FALSE, warning = FALSE}
contrast(contrast1_grid, method = "consec", by="PollutionExposure")

```

### Contrast 4: consec: Fixing exposure to pollution

```{r, message = FALSE, echo = FALSE, warning = FALSE}
contrast(contrast2_grid, method = "consec", by="DoctorRate")
...
ggplot (data_final, aes (x = DoctorRate))+
  ...
  theme_bw()+
  labs (x = "Number of Doctors (per 10,000)")
```
